...
from ....core.synthesis.metaballs import generate_voxels_from_rng
...
def create_candidate(taskstream: TaskStream) -> None:
    ...
    voxels, manifest = generate_voxels_from_rng(
        ...
        config.synthesis.metaballs.factor,
        config.synthesis.metaballs.power,
        config.synthesis.metaballs.threshold,
    )
    ...
    candidate_config["synthesis"]["metaballs"]["num_cells"] = candidate.num_cells
    candidate_config["synthesis"]["metaballs"]["radius_min"] = candidate.radius_min
    candidate_config["synthesis"]["metaballs"]["radius_max"] = candidate.radius_max
    ...
    dump_manifest(
        ...
        command_name="gen-candidates-metaballs",
...
def add_parser(subparsers: argparse._SubParsersAction) -> None:
    parser = subparsers.add_parser(
        "gen-candidates-metaballs", help="Generate candidate configurations for search"
    )
